...
export class FhevmDecryptionSignature {
  ...
  static async loadFromLocalStorage(
    ...
    try {
      ...
      if (!result) {
        console.log(`[FhevmDecryptionSignature] No cached signature found. key=${storageKey.key}`);
        return null;
      }
      ...
      try {
        ...
        console.log(`[FhevmDecryptionSignature] Loaded valid cached signature`);
        return kps;
      } catch {
        return null;
      }
  ...
  static async new(
    ...
    try {
      ...
      console.error('[FhevmDecryptionSignature] Failed to create new signature:', err);
      return null;
    }
  }
  ...
  static async loadOrSign(
    ...
    console.log('[FhevmDecryptionSignature] No valid cached signature, generating new one...');
