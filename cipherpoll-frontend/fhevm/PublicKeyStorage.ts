...
export async function publicKeyStorageSet(
  ...
  const storedPublicKey: FhevmStoredPublicKey = {
    publicKeyId: 'default',
    publicKey,
  };

  const storedPublicParams: FhevmStoredPublicParams = {
    publicParamsId: 'default',
    publicParams,
  };

  await db.put('publicKeyStore', { acl: aclAddress, value: storedPublicKey });
  await db.put('paramsStore', { acl: aclAddress, value: storedPublicParams });
}
